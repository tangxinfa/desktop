...
(defun color-theme-utils--colors ()
  `((EmacsDefaultBackground . ,(color-theme-utils--face-background 'default))
    ...
    (EmacsModeLineBackground . ,(color-theme-utils--face-background 'mode-line nil 'header-line-highlight))
    (EmacsModeLineForeground . ,(color-theme-utils--face-foreground 'mode-line nil 'header-line-highlight))
    (EmacsModeLineUnderline . ,(color-theme-utils--face-underline 'mode-line nil 'header-line-highlight))
    (EmacsModeLineHighlightForeground . ,(color-theme-utils--face-foreground 'mode-line-highlight nil 'font-lock-keyword-face))
    (EmacsModeLineInactiveBackground . ,(color-theme-utils--face-background 'mode-line-inactive nil 'header-line))
    (EmacsModeLineInactiveForeground . ,(color-theme-utils--face-foreground 'mode-line-inactive nil 'header-line))
    (EmacsModeLineInactiveUnderline . ,(color-theme-utils--face-underline 'mode-line-inactive nil 'header-line))
